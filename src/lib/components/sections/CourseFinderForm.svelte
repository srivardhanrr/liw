<script>
    ...
    function handleSubmit() {
      console.log({ careerStage, interests, timeCommitment });
      formSubmitted = true;
    }
  </script>
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div class="w-full lg:w-1/2">
          {#if !formSubmitted}
            <form on:submit|preventDefault={handleSubmit} class="bg-white shadow-xl rounded-lg p-8" in:fly="{{ y: 50, duration: 500, easing: cubicOut }}">
              <div class="mb-6">
              ...
              <div class="mb-6">
                <label class="block text-brand-charcoal font-bricolage mb-2">Areas of Interest</label>
                <div class="flex flex-wrap -mx-2">
                  {#each interestAreas as area}
                    <label class="mx-2 mb-2">
                      <input type="checkbox" bind:group={interests} value={area} class="hidden peer">
