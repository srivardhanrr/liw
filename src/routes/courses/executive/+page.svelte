<!-- src/routes/courses/executives/+page.svelte -->
<script>
...
<div class="min-h-screen bg-white">
	<div class="container mx-auto px-4 py-16">
		<h1 class="mb-8 font-playfair text-4xl text-brand-burgundy md:text-5xl">
			L-3 or Level-3 Corporate Training Program (Executives)
		</h1>
		<p class="text-brand-dark mb-12 font-bricolage text-xl">
			Elevate your executive skills and leadership capabilities with our comprehensive Executive
			Training Program.
		</p>
