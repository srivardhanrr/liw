<!-- src/routes/courses/head-teacher/+page.svelte -->
<script>
		...
		},
		{
			...
			courses: [
				...
				},
				{
					...
					fomoQuestion:
						'Ready to break through the glass ceiling? Join us to discover how to lead with confidence and impact.'
				},
				{
					name: 'Workplace Bullying',
					overview:
						'Bullying in the workplace can have serious consequences for employees and organizations. This course provides insights into identifying and addressing workplace bullying, fostering a safe and respectful environment for all.',
					fomoQuestion:
						"Is workplace bullying affecting your team's morale? Learn how to recognize and address bullying effectively!"
				},
				{
					name: 'Workplace Diversity',
					overview:
						'Diversity is a strength that drives innovation and success. This course explores the benefits of workplace diversity, strategies for fostering inclusivity, and the impact of diverse perspectives on organizational performance.',
					fomoQuestion:
						'Ready to harness the power of diversity in your workplace? Join us to create a more inclusive and innovative environment!'
				},
				{
					name: 'Workplace Violence',
					overview:
						'Violence in the workplace can have devastating effects on employees and organizations. This course equips you with the knowledge to recognize warning signs, prevent violent incidents, and respond effectively to protect your team.',
					fomoQuestion:
						'Concerned about workplace safety? Learn how to prevent and address violence in the workplace to protect your team and organization!'
				}
			]
		}
	];
...
<div class="min-h-screen bg-white">
	<div class="container mx-auto px-4 py-16">
		<h1 class="mb-8 font-playfair text-4xl text-brand-burgundy md:text-5xl">
			Head Teacher Training Program
		</h1>
		<p class="text-brand-dark mb-12 font-bricolage text-xl">
			Enhance your leadership skills and educational management expertise with our comprehensive
			Head Teacher Training Program.
		</p>
