<!-- src/routes/courses/startup/+page.svelte -->
<script>
		...
		},
		{
			...
			courses: [
				...
				},
				{
					...
					fomoQuestion:
						"Want to kickstart your sales career or refresh your skills? Don't let opportunities"
				}
			]
		},
		{
			...
			courses: [
				...
				},
				{
					...
					overview:
						"Master the crucial art of Contract Management with our specialized course. Discover how to navigate the details of contracts with vendors, employees, and customers to foster strong business relationships. Effective contract management can prevent financial loss and safeguard your company's reputation, making this course essential for all professionals involved in contractual agreements.",
					fomoQuestion:
						"Are your contracts working for you? Don't let overlooked details jeopardize your business—enroll in our Contract Management course and strengthen your business relationships today!"
				},
				{
				...
				},
				{
					...
					overview:
						"As responsibilities in human resources increasingly extend to managers, it's essential to be equipped with the right skills. Our Human Resource Management course provides foundational knowledge on critical HR tasks like interviewing, safety protocols, and handling sensitive situations. Gain the confidence to address HR challenges effectively and ensure a harmonious workplace.",
					fomoQuestion:
						'Is your team ready to tackle HR challenges head-on? Join our Human Resource Management course online and equip yourself with the essential skills to manage your team effectively and compassionately!'
				},
				{
		...
		},
		{
			...
			courses: [
				...
				},
				{
					...
					fomoQuestion:
						'Is your organization ready for mobile learning? This course will get you there!'
				}
			]
		},
		{
			...
			courses: [
				...
				{
					name: 'Telework and Telecommuting',
					overview:
						'Develop the essential skills for effective remote work, overcoming communication challenges while enjoying the benefits of flexibility and cost savings.',
					fomoQuestion:
						'Is remote work affecting your productivity? This course will enhance your teleworking skills!'
				},
				{
		...
		},
		{
			...
			courses: [
				...
				},
				{
					...
					fomoQuestion:
						'Concerned about bullying in your workplace? Learn how to prevent and address it effectively!'
				},
				{
					name: 'Workplace Harassment',
					overview:
						'Promote a safe and respectful workplace by understanding and preventing harassment. This course covers the legal aspects of harassment, its impact on employees, and strategies for creating a harassment-free environment.',
					fomoQuestion:
						'Want to create a more inclusive and respectful workplace? Join us to learn how to prevent and address harassment effectively!'
				},
				{
					name: 'Workplace Violence',
					overview:
						'Preventing workplace violence is crucial for employee safety and well-being. This course covers the warning signs of violence, de-escalation techniques, and strategies for creating a safe work environment.',
					fomoQuestion:
						'Concerned about workplace safety? Learn how to prevent violence and create a secure environment for your team!'
				}
			]
		}
	];
...
<div class="min-h-screen bg-white">
	<div class="container mx-auto px-4 py-16">
		<h1 class="mb-8 font-playfair text-4xl text-brand-burgundy md:text-5xl">
			Start-up Owner's Training Program
		</h1>
		<p class="text-brand-dark mb-12 font-bricolage text-xl">
			Equip yourself with essential skills to launch and grow your startup through our comprehensive
			Start-up Owner's Training Program.
		</p>
